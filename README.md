...
Left/Right arrows move backward/forward by one visible page in tree and list views. In the tree, `h`/`l` collapse/expand nodes; Up/Down arrows and `j`/`k` move one row at a time.
